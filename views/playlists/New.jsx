...
class New extends React.Component {
    render() {
        ...
        return (
            <>
                <Default title="Create Playlist" bannerTitleLight="New " bannerTitleSolid="Playlist" endpoint="playlists" btnName="playlist" user="logout">
                                    ...
                                    <div className="col-md-12">
                                        <div className="card-block">
                                            ...
                                            <form action="/playlists" method='POST'>
                                                ...
                                                Description: <input className="line mb-3" type="text" name="description" placeholder='Your Vibes for This Playlist Goes Here' /><br />
                                                Playlist Cover: <input className="line mb-3" type="text" name="artwork" placeholder='Your Dope Playlist Art Goes Here (URL)' /><br />
